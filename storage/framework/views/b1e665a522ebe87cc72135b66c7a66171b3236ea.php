...
<html lang="en">
    <head>
    	...
    	<link rel="stylesheet" href="<?php echo e(asset('public/frontend/css/fullpage.css')); ?>">
...
<link rel="icon" type="image/png" href="https://anvaya.online/facilon-co-in/demo/public/frontend/images/favicon.png">
    	<script src="<?php echo e(asset('public/frontend/js/modernizer.js')); ?>"></script>
	</head>
	<style>
	...
	<body>
		...
		<nav id="sidebar">
			...
			<ul class="list-unstyled CTAs">
				<li>
					<a href="<?php echo e(route('expression_interest_show')); ?>" class="article">Get In Touch</a>
				</li>
			</ul>
		</nav>
		<div id="wrapper">
    			...
    			<nav class="navbar navbar-default">
    				<div class="container">
    					<div class="navbar-header">
    						...
    						<a class="navbar-brand" href="<?php echo e(route('/')); ?>"><img src="<?php echo e(asset('public/frontend/images/logo.png')); ?>" alt="image"></a>
    					</div>
    					<div id="navbar" class="navbar-collapse collapse">
    						<ul class="nav navbar-nav navbar-right">
    							...
    							<li>
    								<a href="<?php echo e(route('ourteam')); ?>">OUR TEAM</a></a>
    								
    							</li>
    								<li>
    								<a href="<?php echo e(route('ourexpertise')); ?>">OUR EXPERTISE </a></a>
    								
    							</li>
    							<li>
    								<a href="<?php echo e(route('faq_show')); ?>">FAQS</a>
    								
    							</li>
                                <li><a href="<?php echo e(route('expression_interest_show')); ?>">CONTACT US</a></li>
    						</ul>
    					</div>
         ...
         <div class="row">
            <div class="col-12 col-sm-3 col-md-3">
               <ul class="footer-links hov policy">
                  <li><a href="<?php echo e(route('aboutus')); ?>">About Us <span class="icon icon-arrow-right2"></span></a></li>
                  <li><a href="<?php echo e(route('ourteam')); ?>">Our Team <span class="icon icon-arrow-right2"></span></a></li>
                  <li class="hidden-xs"><a href="<?php echo e(route('privacypolicy')); ?>">Privacy Policy<span class="icon icon-arrow-right2"></span></a></li>
               </ul>
            </div>
            <div class="col-12 col-sm-3 col-md-3">
               <ul class="footer-links hov big-links">
                  <li><a href="<?php echo e(route('ourexpertise')); ?>">Our Expertise <span class="icon icon-arrow-right2"></span></a></li>
                  <li><a href="<?php echo e(route('ourteam')); ?>">FAQs <span class="icon icon-arrow-right2"></span></a></li>
               </ul>
            </div>
            <div class="col-12 col-sm-3 col-md-3">
               <ul class="footer-links hov big-links">
                  <li><a href="<?php echo e(route('expression_interest_show')); ?>">Contact Us<span class="icon icon-arrow-right2"></span></a></li>
                  <li><a href="<?php echo e(route('termsofuse')); ?>">Terms Of Use<span class="icon icon-arrow-right2"></span></a></li>
               </ul>
            </div>
            <div class="col-12 col-sm-3 col-md-3 footer-block-sec">
               <ul class="footer-links hov big-links mumbai-text">
                  ...
                  <li class="hidden-sm hidden-md hidden-lg"><a href="<?php echo e(route('privacypolicy')); ?>">Privacy Policy<span class="icon icon-arrow-right2"></span></a></li>
               </ul>
...
?>
    ...
    <script src="<?php echo e(asset('public/frontend/js/all.js')); ?>"></script>
    <script src="<?php echo e(asset('public/frontend/js/jquery.nivo.slider.js')); ?>"></script>
    <script src="<?php echo e(asset('public/frontend/js/jquery.appear.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('public/frontend/js/fullpage.js')); ?>"></script>
    <script src="<?php echo e(asset('public/frontend/js/portfolio.js')); ?>"></script>
    <script src="<?php echo e(asset('public/frontend/js/hoverdir.js')); ?>"></script>
...
$(document).ready(function(){
    ...
    <?php if(Route::currentRouteName() == 'service_provider'): ?>
        <script type="text/javascript">
            var myFullpage = new fullpage('#fullpage', {
...
</html><?php /**PATH C:\laragon\www\facilon coin\resources\views/layouts/frontend-header.blade.php ENDPATH**/ ?>