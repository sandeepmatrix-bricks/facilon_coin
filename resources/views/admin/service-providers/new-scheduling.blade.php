                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="date" class="form-control" name="date_of_agreement" value="{{old('date_of_agreement')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="place_of_execution" value="{{old('place_of_execution')}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="name_of_client" value="{{old('name_of_client')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="client_registered_office_address" value="{{old('client_registered_office_address')}}">
                                                </div>
                                            </div>
                                        </div>
