            ...
            <div class="row">
                <div class="col-xl-12 d-flex">
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            <div>
                                <h5 class="mb-1">Add Portfolio Investment Scheme Service</h5>
                            </div>
                            <div class="card-content mt-4">
                                <form action="{{route('admin.add_portfolio_investment_scheme_service')}}" method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                    <div class="row">
                                        <div class="col-md-8">
