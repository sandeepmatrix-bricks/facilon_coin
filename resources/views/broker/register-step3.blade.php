            ...
            <div class="login-form-style3-main">
              <div class="login-form-style3-main_full">
                ...
                <div class="login-register3-form-middle">
                  <form action="{{route('broker_register_step3_submit')}}" data-bitwarden-watching="1" method="post">
                    {{csrf_field()}}
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="single-field">
                            <label for="username"><i class="fa-solid fa-user"></i> Escalation 1 - Name: <span class="star-color">*</span>
                            </label>
                           
                            <input type="text" name="escalation1_name" value="">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="single-field">
                            <label for="username"><i class="fa-solid fa-user"></i>Escalation 1 - Phone: <span class="star-color">*</span>
                            </label>
                           
                            <input type="text" name="escalation1_phone" value="">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="single-field">
                            <label for="username"><i class="fa-solid fa-user"></i> Escalation 1 - Email: <span class="star-color">*</span>
                            </label>
                           
                            <input type="text" name="escalation1_email" value="">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="single-field">
                            <label for="username"><i class="fa-solid fa-user"></i> Escalation 2 - Name: <span class="star-color">*</span>
                            </label>
                           
                            <input type="text" name="escalation2_name" value="">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="single-field">
                            <label for="username"><i class="fa-solid fa-user"></i>Escalation 2 - Phone: <span class="star-color">*</span>
                            </label>
                           
                            <input type="text" name="escalation2_phone" value="">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="single-field">
                            <label for="username"><i class="fa-solid fa-user"></i> Escalation 2 - Email: <span class="star-color">*</span>
                            </label>
                           
                            <input type="text" name="escalation2_email" value="">
                          </div>
                        </div>
                      </div>
