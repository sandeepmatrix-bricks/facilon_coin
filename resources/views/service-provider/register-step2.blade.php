                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="single-field">
                            ...
                            <input type="text" name="primary1_name" value="{{$fetch_sp_details->primary_contact_name1}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="single-field">
                            ...
                            <input type="text" name="primary1_phone" value="{{$fetch_sp_details->primary_contact_phone1}}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="single-field">
                            ...
                            <input type="text" name="primary1_email" value="{{$fetch_sp_details->primary_contact_email1}}">
                          </div>
                        </div>
                      </div>
