  ...
  <section id="services" class="services">
        <div class="container">
          <div class="section-heading mb-40 text-center">
            <div class="sub-heading" style="text-transform: none !important;">FAQs</div>
          ...
          <div class="tablike-sec text-center">
              <div class="rv-1-about__pills">
                ...
                <a href="#investment-in-listed-securities" class="rv-1-about__pill scroll"><div class=""></div>Listed Securities</a>
                <a href="#investment-routes-account-opened" class="rv-1-about__pill scroll"><div class=""></div>Investment routes</a>
                <a href="#portfolio-management-scheme" class="rv-1-about__pill scroll rc-sub-sec"><div class=""></div>Portfolio Management Scheme ('PMS')</a>
                <a href="#portfolio-investment-scheme" class="rv-1-about__pill scroll rc-sub-sec"><div class=""></div>Portfolio Investment Scheme ('PIS')</a>
