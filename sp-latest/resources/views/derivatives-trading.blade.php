...
@php
    $content = $fetch_derivatives_trading_basic_details->description_two;
    // Add a line break before each ✔
    $formatted = str_replace('✔', '<br>✔', $content);
@endphp

<p class="responsive-text">{!! nl2br($formatted) !!}</p>
