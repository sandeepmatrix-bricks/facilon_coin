            ...
            <div class="row">
                <div class="col-xl-12 d-flex">
                    <div class="card radius-10 w-100">
                        <div class="card-body">
                            <div>
                                <h5 class="mb-1">Edit Key Point</h5>
                            </div>
                                ...
                                {{csrf_field()}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="title" placeholder="Enter Title" value="{{ $fetch_key_point_details->title }}">
                                            ...
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="url" placeholder="Enter URL" value="{{ $fetch_key_point_details->url }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row mt-3">
                                                <div class="col-md-12">
                                                    <label>Image <span class="text-danger"> *</span> <a href="{{asset('public/admin/assets/images/key-points/'.$fetch_key_point_details->img_src)}}" class="btn btn-sm btn-primary mb-2" target="_blank">View Image</a></label>
