...
@section('content')
<section class="login-form-style4 section-padding" style="background-image:url('http://localhost/facilon/public/frontend/images/banner/2125.jpg');">
        <div class="container ">
              ...
              <div class="login-form-style3-main">
                <div class="login-form-style3-main_full">
                  ...
                  <div class="login-register3-form-middle">
                    <form action="{{route('investor_email_mobile_update')}}" method="post" data-bitwarden-watching="1">
                      ...
                      <div class="single-field">
                        ...
                        <input type="text" name="email" value="{{$fetch_user_details->email}}">
                      </div>
                      <div class="single-field">
                        ...
                        <select name="country_code">
                            ...
                            @foreach($fetch_country_code as $country_code)
                                <option value="{{$country_code->id}}">+{{$country_code->code_value}} ({{$country_code->country_name}})</option>
                            @endforeach
                            
                        </select>
                        <input type="text" id="" name="mobile_number" value="{{$fetch_user_details->mobile_no}}">                      
                      </div>
                      <div class="single-field">
