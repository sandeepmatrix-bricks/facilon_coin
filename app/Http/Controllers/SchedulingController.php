...
//                     ]);
    ...
    public function new_service_provider_scheduling_add(Request $request)
    {
        ...
        'name_of_client'=>$name_of_client,'type_of_entity'=>$type_of_entity,'company_director_name'=>$company_director_name,
        ...
        //$service_agreement_url = 'https://demo.facilonservices.co.in/sp-service-agreement?status='.$sp_email_address;
        
        $service_agreement_url = 'https://demo.facilonservices.co.in/service-provider/register/step1/1?status='.$sp_email_address;
